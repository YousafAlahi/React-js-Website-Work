...
{/* 1st Section Start */}
<div className="w-full flex flex-col items-center justify-between bg-green-800 gap-3 py-12">
  <h1 className="text-xl lg:text-4xl font-semibold lg:font-bold text-white">Reviews</h1>
  <p className="text-white text-base">Our reviews of the latest games, consoles, keyboards, controllers, and more.</p>
  <ul className="flex gap-2 text-white">
    <li className="font-bold uppercase hover:text-red-700 cursor-pointer transition-all">Multiplatform</li>
    <li className="font-bold border-l-2 border-white pl-4 uppercase hover:text-red-700 cursor-pointer transition-all">keyboards</li>
    <li className="font-bold border-l-2 border-white pl-4 uppercase hover:text-red-700 cursor-pointer transition-all">Switch</li>
    <li className="font-bold border-l-2 border-white pl-4 uppercase hover:text-red-700 cursor-pointer transition-all">Etc</li>
    <li className="font-bold border-l-2 border-white pl-4 uppercase hover:text-red-700 cursor-pointer transition-all">PC</li>
